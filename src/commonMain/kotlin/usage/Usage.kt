...
class Usage private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (serverToolUse != other.serverToolUse) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (serverToolUse?.hashCode() ?: 0)
        return result
    }
...
class ServerToolUse private constructor(
    ...
    override fun hashCode(): Int {
        var result = webSearchRequests ?: 0
        result = 31 * result + (webFetchRequests ?: 0)
        return result
    }
