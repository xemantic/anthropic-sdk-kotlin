...
class RedactedThinkingBlockSerializationTest {
    ...
    @Test
    fun `should serialize RedactedThinkingBlock with cache control`() {
        anthropicJson.encodeToString<Content>(
            RedactedThinkingBlock {
                data = "encrypted_thinking_data_here"
    ...
    @Test
    fun `should deserialize RedactedThinkingBlock with cache control`() {
        anthropicJson.decodeFromString<Content>(
            """
            {
              "type": "redacted_thinking",
